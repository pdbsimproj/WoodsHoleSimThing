...
https://github.com/datalimited/stocksims - see simulated dir for some examples of setups (FLR)
https://github.com/SNAPwg/SNAP - a data limited approach using csv files
https://github.com/szuwalski/GeMS - a two box spatial model for MSE (see the Wiki)
https://www.datalimitedtoolkit.org/ - flashy homepage, lots of interesting computing details under the hood
https://rdrr.io/cran/MSEtool/ - from the makers of DLMtool comes MSEtool - works with analytical assessments instead of data-limited assessments
https://github.com/John-Brandon/PBR-Tier-System - Fortran code for a blast from the past
https://github.com/laurieKell/mpb - Laurie Kell version of MSE for FLR
https://github.com/flr/mse - official FLR version of MSE
https://github.com/ConFooBio/gmse - a complete package including tests and vignettes
https://github.com/cgrandin/msess - because everything is better with SS
https://puntapps.shinyapps.io/tunamse/ - a Shiny MSE
