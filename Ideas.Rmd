...
-------- | -------- | -------- | --------
get.f.pattern.fn.r  | Fishing Mortality | various options to specify F | change options from numeric to literal
setup.asap.wcoat.fn.r  | Input File | Create vanilla ASAP input file | NA
etc. | | | 
